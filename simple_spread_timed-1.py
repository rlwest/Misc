...
class MyAgent(ACTR):
    ...
    start=None                                       # will save the start time
    end=None                                        # will save the end time
    duration=None                                    # will save the time difference

    def init():
        DM.add('customer mustard')
    ...
    def condiment(focus='customer condiment'):  # customer will spread activation to 'customer mustard'
        ...
        DM.request('customer ?')                # request gets boost from spreading activation 
        focus.set('sandwich condiment') 

    def order(focus='sandwich condiment', DMbuffer='customer ?condiment'):  
