...
## bread bottom 
    ...
    def bread3a(Focusbuffer='unit_task:bread_bottom task_goal:take',
                #Motorbuffer='internal',
                bread='location:on_plate'):
        print 'bread is already on the plate'
        Focusbuffer.set('unit_task:bread_bottom task_goal:put')
    def bread3b(Focusbuffer='unit_task:bread_bottom task_goal:take',
                #Motorbuffer='internal',
                bread='location:on_counter'):
        print 'bread not on plate'
        Motor.do_bread()
        Focusbuffer.set('unit_task:bread_bottom task_goal:put')
        Motorbuffer.set('state:external')
    def bread4(Focusbuffer='unit_task:bread_bottom task_goal:put',
               bread='location:on_plate'):
        print 'done'
