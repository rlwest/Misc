...
class Sock_drawer(ccm.Model):
  sock1=ccm.Model(isa='sock',location='in_drawer',feature1='red_stripe',salience=0.1)
  sock2=ccm.Model(isa='sock',location='in_drawer',feature1='blue_stripe',salience=0.9)
  spider=ccm.Model(isa='spider',location='in_drawer',feature1='hairy',salience=0.9)
...
class MyAgent(ACTR): 
  ...
  def found_other(focus_buffer='isa:?object location:?loc action:get',visual_buffer='isa:!?object location:?loc feature1:?feature1'):
    print 'I found - - - '
    print object
    focus_buffer.set('isa:?object location:?loc feature1:?feature1 action:check')
    visual_buffer.clear
